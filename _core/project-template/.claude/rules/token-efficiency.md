...
Approval to open the PR covers this merge. A PR that changes `.github/workflows/` gets no AI review in CI; it merges only as `review-tiers.md` § PRs that edit the review workflow describes.
