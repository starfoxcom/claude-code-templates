...
const TOOL_SLOTS = [
  {
    ...
    options: [
      { name: "tokensave", desc: "Open-source code-graph MCP — indexes your codebase as a graph so Claude can ask \"where is X / what calls Y\" without reading whole files.", url: "https://github.com/aovestdipaperino/tokensave" },
      { name: "ast-grep", desc: "Structural search across ASTs — pattern-based code search that understands syntax, not text.", url: "https://ast-grep.github.io" },
      { name: "Sourcegraph", desc: "Hosted code search across repositories with semantic understanding + references.", url: "https://sourcegraph.com" },
      { name: "ctags", desc: "Decades-old indexer producing tag files for jump-to-definition. Universal Ctags is the maintained fork.", url: "https://ctags.io" },
      { name: "Semgrep", desc: "Lightweight static analysis with rule patterns; doubles as AST-aware grep.", url: "https://semgrep.dev" },
      { name: "none", desc: "Plain grep / glob / Read. Cheapest setup; most tokens spent on file reads.", url: null },
    ],
    default: "tokensave",
  },
  {
...
const TOGGLE_GROUPS = [
  {
    ...
    toggles: [
      ...
      { id: "github_actions_paths_ignore_auto_merge", short: "Auto-merge on paths-ignore PRs", controls: "token-efficiency.md + git.md", blurb: "Docs / rules / CI-YAML-only PRs auto-merge after 90s grace.", d: TG([ON, OFF, OFF, OFF]) },
  ...
  },
  {
    ...
    toggles: [
      ...
      { id: "tokensave_entry_point", short: "Tokensave-first code research (hook-enforced)", controls: "CLAUDE.md + ~/.claude/hooks/tokensave-first.py + /find skill", blurb: "Routes code research through tokensave (open-source code-graph MCP). Installs the GLOBAL PreToolUse hook + /find skill + CLAUDE.md callout + session-close adherence metric.", d: TG([ASK, ASK, ASK, ASK]) },
