...
const TOOL_SLOTS = [
  ...
  },
  {
    ...
    options: [
      ...
      { key: "husky", name: "husky", desc: "Classic JS-ecosystem hooks manager. Lives in package.json scripts.", url: "https://typicode.github.io/husky" },
...
const TOGGLE_GROUPS = [
  ...
  },
  {
    ...
    toggles: [
      ...
      { id: "precommit_hooks_scaffold", short: "Pre-commit hooks scaffold", controls: "per tools.precommit", blurb: "Profile-driven config for the selected pre-commit manager (lefthook/husky/pre-commit/simple-git-hooks) with lint/typecheck/conventional-commit-msg/test hooks.", d: TG([OFF, ON, OFF, ON]) },
    ],
  },
  {
    id: "specialized",
