...
const TOOL_SLOTS = [
  ...
  },
  {
    ...
    options: [
      { key: "lefthook", name: "lefthook", desc: "Fast, polyglot Git hooks manager. YAML config; parallel hook execution.", url: "https://lefthook.dev" },
      { key: "husky", name: "husky", desc: "JS-ecosystem hooks manager (v9): hooks are files in .husky/, run via the npm prepare script.", url: "https://typicode.github.io/husky" },
      { key: "pre-commit", name: "pre-commit", desc: "Python framework with a huge plugin catalog; manages hook environments per repo.", url: "https://pre-commit.com" },
      { key: "simple-git-hooks", name: "simple-git-hooks", desc: "Minimal hooks manager. No frills, no dependencies.", url: "https://github.com/toplenboren/simple-git-hooks" },
      { key: "none", name: "none", desc: "Run lint/format/test manually or only via CI.", url: null },
    ],
    default: "lefthook",
  },
  {
...
const TOGGLE_GROUPS = [
  ...
  },
  {
    ...
    toggles: [
      ...
      { id: "precommit_hooks_scaffold", short: "Pre-commit hooks scaffold", controls: "per tools.precommit", blurb: "Profile-driven config for the selected pre-commit manager (lefthook/husky/pre-commit/simple-git-hooks) — lint/typecheck on commit, plus commit-msg/test gates where the manager scaffolds them.", d: TG([OFF, ON, OFF, ON]) },
    ],
  },
  {
    id: "specialized",
